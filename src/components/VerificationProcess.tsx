            ...
            >
              ...
              <div className="mt-16 grid grid-cols-2 max-sm:gap-5 gap-8 text-center">
                <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 shadow-lg">
                  <p className="text-2xl max-sm:text-xl font-bold bg-gradient-to-r from-rematal-primary to-rematal-blue bg-clip-text text-transparent mb-4">{APP_CONSTANTS.CURR_FREELANCER_COUNT}+</p>
